[![banner](https://particles.js.org/images/banner2.webp)](https://particles.js.org)
...
- Event mode key: `interactivity.events.onHover.mode` or `interactivity.events.onClick.mode` with value `"repulse"`
- Mode options key: `interactivity.modes.repulse`
