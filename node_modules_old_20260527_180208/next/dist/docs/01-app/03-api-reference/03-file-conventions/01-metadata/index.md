...
Each file convention can be defined using a static file (e.g. `opengraph-image.webp`), or a dynamic variant that uses code to generate the file (e.g. `opengraph-image.js`).
