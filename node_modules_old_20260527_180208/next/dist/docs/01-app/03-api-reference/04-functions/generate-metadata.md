...
export async function generateMetadata(
  ...
  return {
    title: product.title,
    openGraph: {
      images: ['/some-specific-page-image.webp', ...previousImages],
    },
  }
}
...
<meta property="og:image" content="https://acme.com/og-image.webp" />
```
...
export const metadata = {
  openGraph: {
    ...
    images: [
      {
        url: 'https://nextjs.org/og.webp', // Must be an absolute URL
        width: 800,
        height: 600,
      },
      {
        url: 'https://nextjs.org/og-alt.webp', // Must be an absolute URL
        width: 1800,
        height: 1600,
        alt: 'My custom alt',
      },
...
<meta property="og:image" content="https://nextjs.org/og.webp" />
<meta property="og:image:width" content="800" />
<meta property="og:image:height" content="600" />
<meta property="og:image" content="https://nextjs.org/og-alt.webp" />
...
```html filename="<head> output" hideLineNumbers
<link rel="shortcut icon" href="/shortcut-icon.webp" />
<link rel="icon" href="/icon.webp" />
<link rel="apple-touch-icon" href="/apple-icon.webp" />
<link
  rel="apple-touch-icon-precomposed"
  href="/apple-touch-icon-precomposed.webp"
/>
```
...
export const metadata = {
  icons: {
    icon: [
      { url: '/icon.webp' },
      new URL('/icon.webp', 'https://example.com'),
      { url: '/icon-dark.webp', media: '(prefers-color-scheme: dark)' },
    ],
    shortcut: ['/shortcut-icon.webp'],
    apple: [
      { url: '/apple-icon.webp' },
      { url: '/apple-icon-x3.webp', sizes: '180x180', type: 'image/png' },
    ],
    other: [
      {
        rel: 'apple-touch-icon-precomposed',
...
<link rel="shortcut icon" href="/shortcut-icon.webp" />
<link rel="icon" href="/icon.webp" />
<link rel="icon" href="https://example.com/icon.webp" />
<link rel="icon" href="/icon-dark.webp" media="(prefers-color-scheme: dark)" />
<link rel="apple-touch-icon" href="/apple-icon.webp" />
<link
  rel="apple-touch-icon-precomposed"
  href="/apple-touch-icon-precomposed.webp"
...
export const metadata = {
  twitter: {
    ...
    images: ['https://nextjs.org/og.webp'], // Must be an absolute URL
  },
}
```
...
<meta name="twitter:image" content="https://nextjs.org/og.webp" />
```
...
export const metadata = {
  ...
  appleWebApp: {
    ...
    startupImage: [
      '/assets/startup/apple-touch-startup-image-768x1004.webp',
      {
        url: '/assets/startup/apple-touch-startup-image-1536x2008.webp',
...
<link
  href="/assets/startup/apple-touch-startup-image-768x1004.webp"
  rel="apple-touch-startup-image"
/>
<link
  href="/assets/startup/apple-touch-startup-image-1536x2008.webp"
  media="(device-width: 768px) and (device-height: 1024px)"
  rel="apple-touch-startup-image"
/>
<meta
