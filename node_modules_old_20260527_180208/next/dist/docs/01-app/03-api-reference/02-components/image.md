...
| ----------------------------------------- | ---------------------------------------- | --------------- | ---------- |
| [`src`](#src)                             | `src="/profile.webp"`                     | String          | Required   |
...
| [`overrideSrc`](#overridesrc)             | `overrideSrc="/seo.webp"`                 | String          | -          |
...
```jsx
<Image src="https://example.com/profile.webp" />
```
...
```jsx
<Image src="/profile.webp" width={500} height={500} />
```
...
```js
<Image src="/profile.webp" fill={true} />
```
...
<img
  srcset="
    /_next/image?url=%2Fprofile.webp&w=640&q=75 1x,
    /_next/image?url=%2Fprofile.webp&w=828&q=75 2x
  "
  src="/_next/image?url=%2Fprofile.webp&w=828&q=75"
/>
```
...
```jsx filename="input.js"
<Image src="/profile.webp" overrideSrc="/override.webp" />
```
...
If you need to change the caching behavior per image, you can configure [`headers`](/docs/app/api-reference/config/next-config-js/headers) to set the `Cache-Control` header on the upstream image (e.g. `/some-asset.webp`, not `/_next/image` itself).
...
The default behavior allows you to import static files such as `import icon from './icon.webp'` and then pass that to the `src` property. In some cases, you may wish to disable this feature if it conflicts with other plugins that expect the import to behave differently.
...
export default function MyImage() {
  return <Image className={styles.image} src="/my-image.webp" alt="My Image" />
}
```
...
export default function MyImage() {
  return (
    <Image style={{ borderRadius: '8px' }} src="/my-image.webp" alt="My Image" />
  )
}
```
...
<div style={{ position: 'relative' }}>
  <Image fill src="/my-image.webp" alt="My Image" />
</div>
```
...
<Image
  ...
  srcLight="/docs/light/responsive-image.webp"
  srcDark="/docs/dark/responsive-image.webp"
  width="1600"
  height="629"
/>
...
<Image
  ...
  srcLight="/docs/light/fill-container.webp"
  srcDark="/docs/dark/fill-container.webp"
  width="1600"
  height="529"
/>
...
<Image
  ...
  srcLight="/docs/light/background-image.webp"
  srcDark="/docs/dark/background-image.webp"
  width="1600"
  height="427"
/>
...
export default function Page() {
  return (
    <Image
      src="https://s3.amazonaws.com/my-bucket/profile.webp"
      alt="Picture of the author"
      width={500}
      height={500}
    />
...
export default function Home() {
  const {
    props: { srcSet },
  } = getImageProps({ alt: '', width: 128, height: 128, src: '/img.webp' })
