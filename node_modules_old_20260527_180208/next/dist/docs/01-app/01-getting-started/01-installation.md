...
<Image
  ...
  srcLight="/docs/light/app-getting-started.webp"
  srcDark="/docs/dark/app-getting-started.webp"
  width="1600"
  height="363"
/>
...
You can then reference these assets using the root path (`/`). For example, `public/profile.webp` can be referenced as `/profile.webp`:

```tsx filename="app/page.tsx" highlight={4} switcher
import Image from 'next/image'

export default function Page() {
  return <Image src="/profile.webp" alt="Profile" width={100} height={100} />
}
```
...
<Image
  ...
  srcLight="/docs/light/typescript-command-palette.webp"
  srcDark="/docs/dark/typescript-command-palette.webp"
  width="1600"
  height="637"
/>
