 ...
 *   ])
 *   .toFile('combined.webp');
 *
 * @example
 * const output = await sharp('input.gif', { animated: true })
 *   .composite([
 *     { input: 'overlay.webp', tile: true, blend: 'saturate' }
 *   ])
 *   .toBuffer();
 *
 * @example
 ...
 *   .composite([{ input: 'overlay.webp', gravity: 'southeast' }])
 *   .sharpen()
 *   .withMetadata()
 *   .webp( { quality: 90 } )
 *   .toBuffer()
 ...
 *     // onto orange background, composited with overlay.webp with SE gravity,
