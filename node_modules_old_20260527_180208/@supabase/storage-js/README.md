...
<p align="center">
  <a href="https://supabase.io">
      ...
      <img alt="Supabase Logo" width="300" src="https://raw.githubusercontent.com/supabase/supabase/master/packages/common/assets/images/logo-preview.webp">
    </picture>
  </a>
...
// Upload files
await storageClient.from('my-files').upload('avatar.webp', file)
```
